    ...
    <Box sx={{ display: "flex", width: "95%" }} >
      ...
      >
        ...
        >
          ...
          <p style={{ width: "30%", fontSize: "14px", textAlign: "center", color: "gray" }} >Please contact our support team to activate your subscription or get assistance, or click "Contact Us" below.</p>
          <button className="check-btn flex gap-2 items-center"><LuHeadset />Contact Us</button>
        </Box>
